...
if __name__ == "__main__":
  ...
  # range of variables to test
    ...
    for entries in daily_entries_range:
        model_params.det_entry_array = np.full(shape=model_days,
                                        fill_value=entries,
                                        dtype=int)
        sims.append(UniMarketsDet(daily_printout_day=600))
        label_names.append(f'{entries} entries at 5 ETH per day')
