...
from BondingCurveNexus.model_params import NXM_exit_values, wnxm_move_size
...
def main():
    ...
    fig.suptitle(f'''Deterministic Model, Solidity Contracts
                 ...
                 Arbitrage transactions only - {wnxm.arb_sale_size_nxm} NXM at a time
                 wNXM price movement of {wnxm_move_size} ETH per 1 ETH bought
                 ''',
                 fontsize=16)
    # fig.tight_layout()
