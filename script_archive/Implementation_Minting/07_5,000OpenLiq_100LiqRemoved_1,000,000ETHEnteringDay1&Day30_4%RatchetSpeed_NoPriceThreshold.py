...
def main():
    ...
    run_name = "07_5,000OpenLiq_100LiqRemoved_1,000,000ETHEnteringDay1&Day30_4%RatchetSpeed_NoPriceThreshold"
    ...
    fig.suptitle(f'''Deterministic Protocol-only Model, Solidity Contracts
                 ...
                 Testing {eth_in} ETH entering at start and end of simulation
                 ''',
                 fontsize=16)
    # fig.tight_layout()
