...
def main():
    ...
    run_name = "5,000OpenLiq_1,500LiqIn_43,835ReserveLiq_2,025,000NXMExiting_45%Ratchet"
    eth_reserve = 43_835
    ...
    fig.suptitle(f'''Deterministic Protocol-only Model, Solidity Contracts
                 ...
                 Initial high-injection ETH reserve of {eth_reserve} ETH. Ratchet speed = 45% of BV/day
