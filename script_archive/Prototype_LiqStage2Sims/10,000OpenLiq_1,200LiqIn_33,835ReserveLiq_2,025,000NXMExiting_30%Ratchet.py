...
def main():
    ...
    run_name = "10,000OpenLiq_1,200LiqIn_33,835ReserveLiq_2,025,000NXMExiting_30%Ratchet"
    eth_reserve = 33_835
    ...
    fig.suptitle(f'''Deterministic Protocol-only Model, Solidity Contracts
                 ...
                 Initial high-injection ETH reserve of {eth_reserve} ETH. Ratchet speed = 30% of BV/day
                 Initial liquidity movement/day resulting in max of 1200 ETH injection. Withdrawal and long-term injection at 100 ETH/day
    ...
    axs[1, 1].set_title('nxm_reserve_ramm')
    axs[1, 1].legend()
    # Subplot
    ...
    axs[2, 0].set_title('eth_liquidity_ramm')
    axs[2, 0].legend()
    # Subplot
