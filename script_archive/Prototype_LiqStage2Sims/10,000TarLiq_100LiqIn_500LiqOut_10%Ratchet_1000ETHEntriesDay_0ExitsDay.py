...
def main():
    ...
    run_name = "10,000TarLiq_100LiqIn_500LiqOut_10%Ratchet_1000ETHEntriesDay_0ExitsDay"
    # eth_reserve = 43_835
    ...
    fig.suptitle(f'''Deterministic Market Model, Solidity Contracts
                 ...
                 Ratchet speed = 10% of BV/day. Withdrawal of 500 ETH/day and long-term injection at 100 ETH/day
