...
def main():
    ...
    run_name = "10,000OpenLiq_1,500LiqIn_33,835ReserveLiq_2,025,000NXMExiting_20%Ratchet"
    eth_reserve = 33_835
    ...
    fig.suptitle(f'''Deterministic Protocol-only Model, Solidity Contracts
                 ...
                 Initial high-injection ETH reserve of {eth_reserve} ETH. Ratchet speed = 20% of BV/day
