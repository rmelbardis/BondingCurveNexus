...
def main():
    ...
    run_name = "ProtOnly_10,000TarLiq_100LiqIn_100LiqOut_2.5%Ratchet_100ETHEntriesDay_0ExitsDay"
    # eth_reserve = 43_835
    ...
    fig.suptitle(f'''Deterministic Protocol Model, Solidity Contracts
                 Target liq of {liq_prediction[0]} ETH. Ratchet speed = 2.5% of BV/day.
