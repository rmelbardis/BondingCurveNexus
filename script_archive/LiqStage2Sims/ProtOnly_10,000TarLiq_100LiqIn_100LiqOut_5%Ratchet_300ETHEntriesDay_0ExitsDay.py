...
def main():
    ...
    run_name = "ProtOnly_10,000TarLiq_100LiqIn_100LiqOut_5%Ratchet_300ETHEntriesDay_0ExitsDay"
    # eth_reserve = 43_835
    ...
    fig.suptitle(f'''Deterministic Protocol Model, Solidity Contracts
                 Target liq of {liq_prediction[0]} ETH. Ratchet speed = 5% of BV/day.
                 Withdrawal of 100 ETH/day and long-term injection at 100 ETH/day
