...
def main():
    ...
    run_name = "ProtOnly_10,000TarLiq_100LiqIn_500LiqOut_5%Ratchet_300ETHEntriesDay_0ExitsDay"
    # eth_reserve = 43_835
    ...
    fig.suptitle(f'''Deterministic Protocol Model, Solidity Contracts
                 ...
                 Ratchet speed = 5% of BV/day. Withdrawal of 500 ETH/day and long-term injection at 100 ETH/day
