...
def main():
    ...
    run_name = "ProtOnly_10,000TarLiq_100LiqIn_100LiqOut_3.75%Ratchet_4x25ETHEntriesDay_0ExitsDay_1.2xBvThreshold"
    # eth_reserve = 43_835
    ...
    fig.suptitle(f'''Deterministic Protocol Model, Solidity Contracts
                 Target liq of {liq_prediction[0]} ETH. Ratchet speed = 3.75% of BV/day.
