...
def main():
    ...
    run_name = "10,000TarLiq_100LiqIn_1000LiqOut_10%Ratchet_10EntriesDay_0ExitsDay"
    # eth_reserve = 43_835
    ...
    fig.suptitle(f'''Deterministic Market Model, Solidity Contracts
                 ...
                 Ratchet speed = 10% of BV/day. Withdrawal of 1000 ETH/day and long-term injection at 100 ETH/day
