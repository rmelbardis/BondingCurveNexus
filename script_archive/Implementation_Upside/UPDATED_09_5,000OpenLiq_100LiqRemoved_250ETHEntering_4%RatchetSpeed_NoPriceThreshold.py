...
def main():
    ...
    #         snapshot_id = read("snapshot.json")
    #         networks.provider._make_request("evm_revert(snapshot_id)")
    # except:
    #     pass

    # snapshot_id = networks.provider._make_request("evm_snapshot")
    # write("snapshot.json", snapshot_id)
    ...
    run_name = "UPDATED_09_5,000OpenLiq_100LiqRemoved_250ETHEntering_4%RatchetSpeed_NoPriceThreshold"
    ratchet_speed = 4 
    liq_withdrawal = 100
    ...
    for i in range(quarter_days):
        ...
        # SWAP ETH EVERY TIME
        print(f'before swap liquidity = {liq_prediction[-1]}')
        ...
        print(f'after swap liquidity = {liq_prediction[-1]}')
    ...
    # copy graph
    graph_dest_dir = src_dir + "/graphs/implementation_upside_testing"
    ...
    # copy script
    script_dest_dir = src_dir + "/script_archive/Implementation_Upside"
